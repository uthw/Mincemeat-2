LootJS.modifiers((event) => {
    ...
    event
        ...
        .addWeightedLoot(
            [3, 6],
            [Item.of("create:andesite_alloy").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 2],
            [Item.of("iceandfire:sapphire").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 8],
            [Item.of("iceandfire:dragonbone").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 2],
            [Item.of("neapolitan:chocolate_cake").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [8, 24],
            [Item.of("apotheosis:gem_fused_slate").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 16],
            [Item.of("miners_delight:cave_carrot").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [6, 12],
            [Item.of("miners_delight:bat_cookie").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [2, 6],
            [Item.of("miners_delight:baked_squid").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [8, 32],
            [Item.of("miners_delight:moss").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [2, 6],
            [Item.of("miners_delight:baked_tentacles").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [2, 6],
            [Item.of("oceansdelight:baked_stuffed_cod").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [10, 20],
            [Item.of("create:experience_nugget").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 1],
            [Item.of("irons_spellbooks:cooldown_ring").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 1],
            [Item.of("irons_spellbooks:fireward_ring").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [6, 14],
            [Item.of("apotheosis:scrap_tome").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 4],
            [Item.of("apotheosis:improved_scrap_tome").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 1],
            [Item.of("eidolon:wraith_heart").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 1],
            [Item.of("eidolon:zombie_heart").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 1],
            [Item.of("thermal:basalz_rod").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 1],
            [Item.of("thermal:blitz_rod").withChance(100)]
        );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 1],
            [Item.of("thermal:blizz_rod").withChance(100)]
    );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 2],
            [Item.of("forbidden_arcanus:rune").withChance(100)]
    );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 4],
            [Item.of("irons_spellbooks:magic_cloth").withChance(100)]
    );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 1],
            [Item.of("enigmaticlegacy:earth_heart").withChance(100)]
    );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 1],
            [Item.of("enigmaticlegacy:tattered_tome").withChance(100)]
    );
    ...
    event
        ...
        .addWeightedLoot(
            [1, 1],
            [Item.of("alexsmobs:unsettling_kimono").withChance(100)]
    );
});
