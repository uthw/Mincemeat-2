...
ServerEvents.tags("entity_type", (event) => {
    ...
    event.add("champions:is_ender", "endermanoverhaul:mushroom_fields_enderman");
    ...
    event.add("champions:is_ender", "endermanoverhaul:soulsand_valley_enderman");
    ...
    event.add("champions:is_ender", "endermanoverhaul:windswept_hills_enderman");
