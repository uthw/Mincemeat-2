ServerEvents.tags("item", (event) => {
    ...
    const add = [
        ...
        ["create:modded_stripped_logs", "biomeswevegone:stripped_blue_enchanted_log"],
        ...
        ["create:modded_stripped_logs", "biomeswevegone:stripped_green_enchanted_log"],
        ...
        ["create:modded_stripped_logs", "biomeswevegone:stripped_jacaranda_log"],
        ...
        ["create:modded_stripped_logs", "biomeswevegone:stripped_rainbow_eucalyptus_log"],
        ...
        ["create:modded_stripped_logs", "biomeswevegone:stripped_white_mangrove_log"],
        ["create:modded_stripped_logs", "biomeswevegone:stripped_willow_log"],
        ["create:modded_stripped_logs", "biomeswevegone:stripped_witch_hazel_log"],
    ...
    event.removeAllTagsFrom("artifacts:umbrella")
