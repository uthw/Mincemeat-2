PlayerEvents.advancement((event) => {
    ...
    event.server.runCommand("gamerule persistentAnimals false");
    ...
    event.server.runCommand("gamerule artifacts.eternalSteak.enabled false");
    event.server.runCommand("gamerule artifacts.everlastingBeef.enabled false");
